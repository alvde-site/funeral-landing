function Calculator() {
  ...
  return (
    <section className="calculator">
            <h3>Калькулятор благоустройства</h3>
            <div className="info-box">
                <span className="close">&times;</span>
                <div className="info-box__wrap"><img src="images/dest/info.png" alt="Информация"></img>
                </div>
            </div>
            <form className="calc" action="/action_page.php">
                ...
                <div className="calc__size__field margin-bottom">
                    <button className="number-minus" type="button" onClick={stepdown}>-</button>
                    <input id="numberPlaces" type="number" min="0" max="8" value="1" readOnly></input>
                    <button className="number-plus" type="button" onClick={stepup}>+</button>
                </div>
                ...
                <div className="calc__size margin-bottom">
                    ...
                    <div className="calc__size__field margin-bottom">
                        <button className="number-minus" type="button" onClick={stepdown}>-</button>
                        <input id="width" type="number" min="120" value="120" step="30" readOnly></input>
                        <button className="number-plus" type="button" onClick={stepup}>+</button>
                    </div>
                    <span className="info-active">&#10068</span>
                    ...
                    <div className="calc__size__field margin-bottom">
                        <button className="number-minus" type="button" onClick={stepdown}>-</button>
                        <input id="height" type="number" min="120" value="120" step="30" readOnly></input>
                        <button className="number-plus" type="button" onClick={stepup}>+</button>
                    </div>
                    <span className="info-active">&#10068</span>
                ...
                <div className="calc__button">
                    <button type="button" id="resultButton"><a href="#result">Рассчитать</a></button>
                    <input type="reset" id="resetButton" value="Сбросить"></input>
                </div>
                <p className="conditions">Расчет является предварительным. Точные условия можно узнать по телефону.</p>
            </form>
            <div className="result" id="result">
                <h3>Расчет стоимости и количества</h3>
                <div className="calc">
                    <div className="result__tile">
                        <p>Количество плит: <span id="tile-count"></span> шт.</p>
                        <p>Стоимость плит: <span id="tile-price"></span></p>
                        <p id="curb-count"></p>
                        <p id="curb-price"></p>
                        <p>Итог: <span id="improveResult"></span></p>
                    </div>
